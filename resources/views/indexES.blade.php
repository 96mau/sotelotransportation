...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h4 class="m-0 text-primary"><img src="{{ asset('img/LogoSotelo.svg') }}" style="width: 50px;"
                    ...
                    <div class="carousel-caption d-flex align-items-center">
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                ...
                                <div class="palladax col-lg-5 d-none d-lg-flex animated zoomIn">
                                    <img class="img-fluid"
            ...
            <div class="row g-5">
                <div class="col-lg-6 pt-4" style="min-height: 400px;">
                    <div class="position-relative h-100 wow fadeIn" data-wow-delay="0.1s">
                        <img class="position-absolute img-fluid w-100 h-100" src="{{ asset('img/Camion.jpg') }}"
                ...
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4"><span class="text-primary">Sotelo Tellez transportation Corp, </span> Truck
                    ...
                    <div class="tab-content w-100">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <h3 class="mb-3">Sotelo Tellez Services at your service.</h3>
        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-6 py-5">
                    <div class="py-5">
                        <h1 class="text-white mb-4">Requesting a Service Quote</h1>
                        {{-- <h1 class="text-white mb-4">Solicitar una cotización de servicio</h1> --}}
                ...
                <div class="col-lg-6">
                    <div class="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn"
                        data-wow-delay="0.6s">
                        <h1 class="text-white mb-4 text-uppercase">Contact</h1>
                        <form>
                            @csrf
                            <div class="row g-3">
    ...
    <section>
        <div class="w-100 row ">
            <div class="col-md-6 col-sm-12">
                <img class="img-fluid " src="{{ asset('img/Dump-Trucks-Freightliner-108SD-26944308.jpg') }}"
                            style="object-fit: cover; width: 100%;" alt="">
            </div>
            <div class="col-md-6 col-sm-12 text-center mt-5 p-5 mr-5">
                <h1 class="mb-4"><span class="text-secondary">"Building Success Together: Your Reliable Partner in Material Transportation and Cargo Truck Rental"</h1>
